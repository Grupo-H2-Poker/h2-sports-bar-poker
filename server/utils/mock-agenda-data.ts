...
export const CASH_GAME_MESAS: CashGameMesaMock[] = [
  { slug: 'omaha-5-5', titulo: 'Omaha 5/5', categoria: 'Cash game', status: 'aberta', badge: { texto: 'ABERTA', cor: 'purple' },  },
  { slug: 'omaha-10-10', titulo: 'Omaha 10/10', categoria: 'Cash game', status: 'aberta', badge: { texto: 'ABERTA', cor: 'purple' },  },
  { slug: 'holdem-2-5', titulo: 'Hold\'em 2/5', categoria: 'Cash game', status: 'aberta', badge: { texto: 'ABERTA', cor: 'purple' },  },
  { slug: 'holdem-5-10', titulo: 'Hold\'em 5/10', categoria: 'Cash game', status: 'off', badge: { texto: 'OFF', cor: 'purple' }, ativo: false },
  { slug: 'plo-1-2', titulo: 'PLO 1/2', categoria: 'Cash game', status: 'aberta', badge: { texto: 'ABERTA', cor: 'purple' },  },
